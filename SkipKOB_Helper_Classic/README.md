...
# SkipKOB_Helper — Classic

**Приложение для учёта прогулов в университете**

Версия на Python + Flet. Тёмная тема · Android и Windows · всё хранится локально
...
> Это основная, рабочая версия — та, что выкладывается в релизы. Рядом лежит
> [Test](../SkipKOB_Helper_Test/) — то же приложение, переписанное на Dart ради
> контроля над физикой жестов. Обзор обеих версий — в [корневом README](../README.md).
...
- Смена недели: кнопками, выбором из сетки или **протягиванием списка за край** —
  с индикатором, который заполняется по мере оттягивания.
...
- **Свайп между страницами** — отключаемый, по умолчанию выключен.
